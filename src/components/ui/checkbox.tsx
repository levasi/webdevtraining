...
const checkboxVariants = cva(
  "peer relative flex shrink-0 cursor-pointer items-center justify-center border border-input transition-colors outline-none group-has-disabled/field:opacity-50 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:bg-input/30 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40",
  {
    variants: {
      variant: {
        default:
          "size-4 rounded-[2px] data-checked:border-primary data-checked:bg-primary data-checked:text-primary-foreground dark:data-checked:bg-primary",
        completed:
          "size-5 rounded-[2px] data-checked:border-green-600 data-checked:bg-green-600 data-checked:text-white dark:data-checked:border-green-600 dark:data-checked:bg-green-600",
      },
    },
    defaultVariants: {
      variant: "default",
